...
export class AdaptationTransactionEngine {
  ...
  public async evaluateSignals(
    ...
    if (health.antiBlockReaction >= 0.50) {
      ...
      // Check if transaction already active for this navigation
      ...
      // Pick top candidate (S3 -> S2 -> S1)
      const topCandidate = candidates[0];
      if (!topCandidate) return null;
      return this.stageTransaction(tabId, navigationId, siteKey, health, topCandidate);
    }
